      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-8">
        ...
        <div className="prose prose-neutral max-w-none text-sm text-gray-700 leading-relaxed space-y-6">
          <section>
            ...
            <p>
              By engaging ASME Studio for website design, software architecture, SaaS platform development, or technical maintenance, you agree to these Terms of Service. All project scopes, deliverables, milestones, and payment schedules are defined in individual Statement of Work (SOW) agreements.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Upon receipt of final payment settlement, 100% of all intellectual property, source code, design assets, Figma files, and database schemas created specifically for the project are permanently transferred to the client. ASME Studio retains zero proprietary locks.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ASME Studio guarantees all scoped deliverables against defects and functional errors for 30 calendar days following production deployment. Scoped bugs reported within this timeframe are diagnosed and patched at zero additional charge.
            </p>
          </section>
