      ...
      <div className="container max-w-7xl mx-auto h-24 px-4 sm:px-6 lg:px-12 flex items-center justify-between pointer-events-auto">
        ...
        <div className="flex items-center">
          <a href="/" className="flex items-center gap-2.5 group">
            <div className="w-8 h-8 rounded-lg bg-red-600 flex items-center justify-center text-white font-black text-sm tracking-tighter shadow-md group-hover:scale-105 transition-transform">
              A
            </div>
            <span className="font-extrabold text-2xl tracking-tight bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent">
              ASME
            </span>
          </a>
        </div>
        ...
        <div className="hidden md:flex items-center">
          <nav className="flex items-center space-x-1 rounded-full p-1.5 shadow-lg bg-white/95 backdrop-blur-md border border-neutral-200/80">
            <a
              href="#featured-work"
              className="text-sm font-medium transition-colors px-5 py-2 rounded-full text-neutral-800 hover:text-red-600 hover:bg-neutral-50"
            >
              Work
            </a>
            <a
        ...
        <div className="hidden md:flex items-center space-x-4">
          <a
            ...
            aria-label="LinkedIn"
            className="text-xs font-semibold text-neutral-800 hover:text-red-600 transition-colors uppercase tracking-wider"
          ...
          <button
            ...
            className="bg-black text-white text-xs font-semibold px-4 py-2 rounded-full hover:bg-red-600 transition-colors flex items-center gap-1 shadow-sm"
          >
            <span>Inquire</span>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="pt-4 mt-4 border-t border-neutral-100 flex items-center justify-between">
              <span className="text-xs text-neutral-500">ASME Studio • Bengaluru</span>
              <button
                type="button"
                onClick={() => {
                ...
                className="bg-red-600 text-white text-xs font-bold px-4 py-2 rounded-full"
              >
                Get In Touch
              </button>
            </div>
